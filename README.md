...
目前已支持国产AI芯片(华为昇腾，摩尔线程，期待更多国产算力芯片)进行推理，下一步将支持国产算力训练，具体可参考昇腾分支[hw branch](https://github.com/PKU-YuanGroup/Open-Sora-Plan/tree/hw)和[MUSA branch](https://github.com/PKU-YuanGroup/Open-Sora-Plan/tree/MUSA). 摩尔卡运行环境配置可参考：https://github.com/MooreThreads/torch_musa/tree/main
