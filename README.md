...
## 📰 News
**[2024.03.08]** We support the training code of text condition with 16 frames of 512x512, but the environment is different from the class condition training code (please use the official command on [here](https://pytorch.org/get-started/locally/) to install torch 2.1 and cuda 11.8 ). The code is written according to the sample code of [Latte](https://github.com/Vchitect/Latte?tab=readme-ov-file)
