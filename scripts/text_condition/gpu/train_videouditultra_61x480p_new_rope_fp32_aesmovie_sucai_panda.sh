...
accelerate launch \
    ...
    --group_frame \
    --speed_factor 1.2 \
    --pretrained "/storage/ongoing/new/image2video_weight/480p_73000_ema_k3_p1_repeat_wusun.pt" \
    --output_dir="bs32x8x2_61x480p_lr1e-4_snr5_noioff0.02_uditultra122_ds122_rope_qknorm_mt5xxl_pandamovie_aes_mo_sucai_mo_speed1.2" 
