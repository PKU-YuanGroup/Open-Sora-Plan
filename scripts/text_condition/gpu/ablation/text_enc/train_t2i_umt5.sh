...
# export NCCL_ALGO=Tree
    ...
    accelerate launch \
        ...
        --cache_dir "../../cache_dir/" \
        --dataset t2v \
        --data /storage/anno_pkl/img_merge_pkl/densecap_1222_512_128part_8txt/part6.txt \
        ...
        --group_data \
        --use_decord \
        --output_dir="t2i_ablation_arch_/umt5" \
        --vae_fp32 \
        --rf_scheduler \
        --proj_name t2i_ablation_arch \
        --log_name umt5_part6 \
        --trained_data_global_step 24875 \
