...
accelerate launch \
    ...
    --text_encoder_name_1 /storage/ongoing/12.13/t2i/Open-Sora-Plan/cache_dir/glm-4v-9b \
    --cache_dir "../../cache_dir/" \
    --dataset t2v \
    --data /storage/anno_pkl/img_merge_pkl/densecap_1222_512_128part_8txt/part4.txt \
    ...
    --group_data \
    --use_decord \
    --output_dir="t2i_ablation_arch/glm4v" \
    --vae_fp32 \
    --rf_scheduler \
    --proj_name t2i_ablation_arch \
    --log_name glm4v_part4 \
    --trained_data_global_step 12125 \
