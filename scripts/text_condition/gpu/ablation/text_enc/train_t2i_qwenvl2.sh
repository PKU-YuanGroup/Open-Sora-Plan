...
accelerate launch \
    ...
    --model OpenSoraT2I-2B/122/QWenVL2 \
    --text_encoder_name_1 /storage/ongoing/12.13/t2i/Open-Sora-Plan/cache_dir/Qwen2-VL-7B-Instruct \
    --cache_dir "../../cache_dir/" \
    --dataset t2v \
    --data /storage/anno_pkl/img_merge_pkl/densecap_1222_512_128part_8txt/part1.txt \
    ...
    --group_data \
    --use_decord \
    --output_dir="t2i_ablation_arch/qwenvl2" \
    --vae_fp32 \
    --rf_scheduler \
    --proj_name t2i_ablation_arch \
    --log_name qwenvl2_part1 \
    --trained_data_global_step 12000 \
