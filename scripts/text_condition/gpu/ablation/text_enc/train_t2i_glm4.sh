...
accelerate launch \
    ...
    --text_encoder_name_1 /storage/ongoing/12.13/t2i/Open-Sora-Plan/cache_dir/glm-4-9b-chat \
    --cache_dir "../../cache_dir/" \
    --dataset t2v \
    --data /storage/anno_pkl/img_merge_pkl/densecap_1222_512_128part_8txt/part7.txt \
    ...
    --group_data \
    --use_decord \
    --output_dir="t2i_ablation_arch/glm4" \
    --vae_fp32 \
    --rf_scheduler \
    --proj_name t2i_ablation_arch \
    --log_name glm4_part7 \
    --trained_data_global_step 22250 \
