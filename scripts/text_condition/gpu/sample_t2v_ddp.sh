...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nnodes=1 --nproc_per_node 8 --master_port 29502 \
    ...
    --model_path /storage/ongoing/new/7.19anyres/Open-Sora-Plan/bs32x8x1_anyx93x320x320_fps16_lr1e-5_snr5_noioff0.02_ema9999_sparse1d4_dit_l_mt5xxl_alldata100m/checkpoint-469000/model_ema \
    --version 65x512x512 \
    --num_frames 93 \
    --height 160 \
    --width 320 \
    ...
    --save_img_path "./sample_video_dit_vae8_newmodel_anyx93x160x320_sora_m0.9_latest469k_s100_wf_xformer" \
    --fps 18 \
    --guidance_scale 7.5 \
