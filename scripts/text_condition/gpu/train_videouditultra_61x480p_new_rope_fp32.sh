...
accelerate launch \
    ...
    --enable_stable_fp32 \
    --group_frame \
    --pretrained 480p_73000_ema_k3_p1_repeat_wusun.pt \
    --output_dir="bs2_20node_73000k_480p_61x480p_lr5e-5_snr5_noioff0.02_ema_rope_uditultra122_qknorm_ds222_mt5xxl_sucai288w" 