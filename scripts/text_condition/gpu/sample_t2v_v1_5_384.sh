...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nnodes=1 --nproc_per_node 8 --master_port 29512 \
    ...
    --model_path 11.10_mmdit13b_dense_rf_bs8192_lr1e-4_max1x384x384_min1x384x288_emaclip99_border109m/checkpoint-24116/model_ema \
    --version v1_5 \
    --num_frames 1 \
    --height 384 \
    --width 384 \
    ...
    --save_img_path "./rf_1x384x384_v1_5_13b_cfg7.0_s100lq1000_24k_diff_osp" \
    --fps 18 \
    --guidance_scale 7.0 \
