...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nnodes=1 --nproc_per_node 8  --master_port 29505 \
    ...
    --text_prompt /storage/ongoing/refine_model/refinecoco500_input.txt \
    --ae CausalVAEModel_D8_4x8x8 \
    --ae_path "/storage/dataset/new488dim8/last" \
    --save_img_path "./sample_video_dit_vae8_newmodel_anyx93x160x320_sora_m0.95_368k_refinecoco500_input" \
    --fps 18 \
    --guidance_scale 7.5 \
