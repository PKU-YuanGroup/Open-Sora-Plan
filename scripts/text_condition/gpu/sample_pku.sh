...
MODEL_PATH=video_test
# export HF_DATASETS_OFFLINE=1 
# export TRANSFORMERS_OFFLINE=1

torchrun --nproc_per_node=8 --master_port=29501 opensora/sample/sample_inpaint_pku.py \
    --model_path /storage/gyy/hw/Open-Sora-Plan/pku_ckpt \
