...
export PROJECT="bs16_4node_480p_lr1e-4_snr5_noise0.02_ema_ps22_ds22_udit22_mt5xl"
...
accelerate launch \
    ...
    --output_dir="bs16_4node_480p_lr1e-4_snr5_noise0.02_ema_ps22_ds22_udit22_mt5xl" \
    --allow_tf32 \
