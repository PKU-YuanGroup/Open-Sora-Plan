...
from mindspeed_mm.tasks.inference.pipeline.opensoraplan_inpaint_pipeline import OpenSoraPlanInpaintPipeline
...
SoraPipeline_dict = {"OpenSoraPlanPipeline": OpenSoraPlanPipeline,
                     "OpenSoraPlanInpaintPipeline": OpenSoraPlanInpaintPipeline,
