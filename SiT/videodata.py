...
class Collate:
    def __init__(self, max_image_size, vae_stride, patch_size, temproal_size, num_frames):
        self.max_image_size = max_image_size
        self.vae_stride = vae_stride
        self.patch_size = patch_size
        self.temproal_size = temproal_size
        self.num_frames = num_frames
    ...
    def __call__(self, batch):
        ...
        t_ds_stride = self.vae_stride * self.temproal_size
        ...
        max_patchify_latent_size = [max_latent_size[0] // self.temproal_size,
