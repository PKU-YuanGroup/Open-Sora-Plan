...
CUDA_VISIBLE_DEVICES=2 python -m opensora.eval.vqascore.step2_genai_image_eval \
    --model_path "/storage/ongoing/12.13/t2i/cache_dir/clip-flant5-xxl" \
    --image_dir ${IMAGE_DIR} \
    --meta_dir ${META_DIR}  >> ${IMAGE_DIR}.txt & \
META_DIR="opensora/eval/eval_prompts/${PROMPT}"
...
CUDA_VISIBLE_DEVICES=5 python -m opensora.eval.vqascore.step2_genai_image_eval \
    --model_path "/storage/ongoing/12.13/t2i/cache_dir/clip-flant5-xxl" \
    --image_dir ${IMAGE_DIR} \
    --meta_dir ${META_DIR}  >> ${IMAGE_DIR}.txt & \
META_DIR="opensora/eval/eval_prompts/${PROMPT}"
