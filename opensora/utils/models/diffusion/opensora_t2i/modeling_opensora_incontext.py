...
from opensora.models.diffusion.opensora_t2i.modules import InContextCombinedTimestepTextProjEmbeddings, InContextBasicTransformerBlock, AdaNorm
from opensora.utils.utils import to_2tuple
from opensora.models.diffusion.common import PatchEmbed2D
from opensora.models.diffusion.opensora_t2i.modules import InContextRoPE3D, InContextPositionGetter3D, FlashFP32LayerNorm
try:
    import torch_npu
...
class OpenSoraT2I_InContext(ModelMixin, ConfigMixin):
    ...
    def _init_patched_inputs(self):
        ...
        self.time_text_embed = InContextCombinedTimestepTextProjEmbeddings(
            timestep_embed_dim=self.config.timestep_embed_dim, 
            embedding_dim=self.config.hidden_size, 
            pooled_projection_dim=self.config.pooled_projection_dim, 
            num_timestep_token=self.config.num_timestep_token, 
        )
        ...
        # 4. rope
        self.rope = InContextRoPE3D(interpolation_scale_thw=interpolation_scale_thw)
        self.position_getter = InContextPositionGetter3D()
        ...
        blockcls = InContextBasicTransformerBlock
    ...
    def forward(
        ...
        **kwargs, 
        ...
        num_visual_tokens = hidden_states.shape[1]
        num_timestep = embedded_timestep.shape[1]
        num_text = encoder_hidden_states.shape[1]
        hidden_states = torch.concat([embedded_timestep, encoder_hidden_states, hidden_states], dim=1)
        embedded_timestep_attn_mask = torch.zeros(batch_size, 1, 1, num_timestep, device=hidden_states.device, dtype=attention_mask.dtype)
        attention_mask = torch.concat([embedded_timestep_attn_mask, encoder_attention_mask, attention_mask], dim=-1)
        # To
        ...
        pos_thw = self.position_getter(
            batch_size, num_timestep, num_text, height, width, 
        ...
        hidden_states = hidden_states[-num_visual_tokens:]
    ...
    def _operate_on_patched_inputs(self, hidden_states, encoder_hidden_states, encoder_hidden_states_2, timestep, pooled_projections):
        ...
        timesteps_emb = self.time_text_embed(timestep, pooled_projections, hidden_states.dtype)  # (N, n, D)
...
def OpenSoraT2I_InContext_2B_111(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
...
def OpenSoraT2I_InContext_2B_122_QWenVL2(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
...
def OpenSoraT2I_InContext_2B_122(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[20, 1, 20], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
        caption_channels=4096, pooled_projection_dim=0, num_timestep_token=2, **kwargs
    )

def OpenSoraT2I_InContext_2B_122_Light(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[16, 1, 16], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_DeepNorm_Shrink(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_PostNorm(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_DeepNorm(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_MixNorm(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_4k3584(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_4k4k(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_SandWichNorm(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_ConvFFN(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_RMSNorm(**kwargs):
...
def OpenSoraT2I_InContext_2B_122_FinalConv(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_DeepNorm_Skip(**kwargs):
...
def OpenSoraT2I_InContext_2B_122_PostNorm_Skip(**kwargs):
    kwargs.pop('skip_connection', None)
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
...
def OpenSoraT2I_InContext_2B_122_Skip(**kwargs):
    kwargs.pop('skip_connection', None)
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
...
def OpenSoraT2I_InContext_2B_122_PreNorm_NormSkip(**kwargs):
    kwargs.pop('skip_connection', None)
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
...
def OpenSoraT2I_InContext_2B_122_PreNorm_Skip(**kwargs):
    kwargs.pop('skip_connection', None)
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
...
def OpenSoraT2I_InContext_2B_122_MixNorm_Skip(**kwargs):
    kwargs.pop('skip_connection', None)
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
...
def OpenSoraT2I_InContext_2B_122_MixNorm_NormSkip(**kwargs):
    kwargs.pop('skip_connection', None)
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
...
def OpenSoraT2I_InContext_2B_122_CLIP(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_TextMLP(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_TimeAsX(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
def OpenSoraT2I_InContext_2B_122_TimeAsT(**kwargs):
    return OpenSoraT2I_InContext(  # 25 layers
        num_layers=[12, 1, 12], 
        attention_head_dim=64, num_attention_heads=24, 
        timestep_embed_dim=512, patch_size_t=1, patch_size=2, 
...
OpenSora_T2I_models = {
    "OpenSoraT2I_InContext-2B/111": OpenSoraT2I_InContext_2B_111, 
    "OpenSoraT2I_InContext-2B/122": OpenSoraT2I_InContext_2B_122, 
    "OpenSoraT2I_InContext-2B/122_Light": OpenSoraT2I_InContext_2B_122_Light, 
    "OpenSoraT2I_InContext-2B/122/QWenVL2": OpenSoraT2I_InContext_2B_122_QWenVL2,
    "OpenSoraT2I_InContext-2B/122/DeepNorm_Shrink": OpenSoraT2I_InContext_2B_122_DeepNorm_Shrink, 
    "OpenSoraT2I_InContext-2B/122/PostNorm": OpenSoraT2I_InContext_2B_122_PostNorm, 
    "OpenSoraT2I_InContext-2B/122/DeepNorm": OpenSoraT2I_InContext_2B_122_DeepNorm, 
    "OpenSoraT2I_InContext-2B/122/MixNorm": OpenSoraT2I_InContext_2B_122_MixNorm, 
    "OpenSoraT2I_InContext-2B/122/4k3584": OpenSoraT2I_InContext_2B_122_4k3584, 
    "OpenSoraT2I_InContext-2B/122/4k4k": OpenSoraT2I_InContext_2B_122_4k4k, 
    "OpenSoraT2I_InContext-2B/122/ConvFFN": OpenSoraT2I_InContext_2B_122_ConvFFN, 
    "OpenSoraT2I_InContext-2B/122/FinalConv": OpenSoraT2I_InContext_2B_122_FinalConv, 
    "OpenSoraT2I_InContext-2B/122/SandWichNorm": OpenSoraT2I_InContext_2B_122_SandWichNorm, 
    "OpenSoraT2I_InContext-2B/122/RMSNorm": OpenSoraT2I_InContext_2B_122_RMSNorm, 
    "OpenSoraT2I_InContext-2B/122/Skip": OpenSoraT2I_InContext_2B_122_Skip, 
    "OpenSoraT2I_InContext-2B/122/PreNorm_NormSkip": OpenSoraT2I_InContext_2B_122_PreNorm_NormSkip, 
    "OpenSoraT2I_InContext-2B/122/PreNorm_Skip": OpenSoraT2I_InContext_2B_122_PreNorm_Skip, 
    "OpenSoraT2I_InContext-2B/122/MixNorm_Skip": OpenSoraT2I_InContext_2B_122_MixNorm_Skip, 
    "OpenSoraT2I_InContext-2B/122/DeepNorm_Skip": OpenSoraT2I_InContext_2B_122_DeepNorm_Skip, 
    "OpenSoraT2I_InContext-2B/122/PostNorm_Skip": OpenSoraT2I_InContext_2B_122_PostNorm_Skip, 
    "OpenSoraT2I_InContext-2B/122/MixNorm_NormSkip": OpenSoraT2I_InContext_2B_122_MixNorm_NormSkip, 
    "OpenSoraT2I_InContext-2B/122/CLIP": OpenSoraT2I_InContext_2B_122_CLIP, 
    "OpenSoraT2I_InContext-2B/122/TextMLP": OpenSoraT2I_InContext_2B_122_TextMLP, 
    "OpenSoraT2I_InContext-2B/122/TimeAsX": OpenSoraT2I_InContext_2B_122_TimeAsX, 
    "OpenSoraT2I_InContext-2B/122/TimeAsT": OpenSoraT2I_InContext_2B_122_TimeAsT, 
}

OpenSora_T2I_models_class = {
    "OpenSoraT2I_InContext-2B/111": OpenSoraT2I_InContext,
    "OpenSoraT2I_InContext-2B/122": OpenSoraT2I_InContext,
    "OpenSoraT2I_InContext-2B/122/Light": OpenSoraT2I_InContext,
    "OpenSoraT2I_InContext-2B/122/QWenVL2": OpenSoraT2I_InContext,
    "OpenSoraT2I_InContext-2B/122/DeepNorm_Shrink": OpenSoraT2I_InContext,
    "OpenSoraT2I_InContext-2B/122/PostNorm": OpenSoraT2I_InContext,
    "OpenSoraT2I_InContext-2B/122/DeepNorm": OpenSoraT2I_InContext,
    "OpenSoraT2I_InContext-2B/122/MixNorm": OpenSoraT2I_InContext,
    "OpenSoraT2I_InContext-2B/122/4k3584": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/4k4k": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/ConvFFN": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/FinalConv": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/SandWichNorm": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/RMSNorm": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/Skip": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/PreNorm_NormSkip": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/PreNorm_Skip": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/DeepNorm_Skip": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/PostNorm_Skip": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/MixNorm_Skip": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/MixNorm_NormSkip": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/CLIP": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/TextMLP": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/TimeAsX": OpenSoraT2I_InContext, 
    "OpenSoraT2I_InContext-2B/122/TimeAsT": OpenSoraT2I_InContext, 
}
...
if __name__ == '__main__':
    ...
    # model = OpenSoraT2I_InContext.from_pretrained("11.10_mmdit13b_dense_rf_bs8192_lr5e-5_max1x384x384_min1x384x288_emaclip99_border109m/checkpoint-5967/model_ema")
    ...
    model = OpenSoraT2I_InContext_2B_122(
        in_channels=c, 
        out_channels=c, 
