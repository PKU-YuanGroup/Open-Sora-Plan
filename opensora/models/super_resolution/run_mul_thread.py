...
if __name__ == "__main__":
    ...
    parser.add_argument("--mul_numwork", type=int, default = 32, help ='max_workers to execute Multi')
    parser.add_argument("--frames_total", type=int, default = 200,  help ='How many frames are superdivided at a time')
