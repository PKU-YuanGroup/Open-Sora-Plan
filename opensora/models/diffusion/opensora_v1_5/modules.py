...
class BasicTransformerBlock(nn.Module):
    def __init__(
        ...
        # 1. Self-Attn
        self.norm1 = OpenSoraLayerNormZero(dim, norm_elementwise_affine, norm_eps, bias=True)
        ...
        # 3. Feed-forward
        self.norm3 = OpenSoraLayerNormZeroMlp(dim, norm_elementwise_affine, norm_eps, bias=True)
        self.ff = FeedForward(
            dim,
            dropout=dropout,
