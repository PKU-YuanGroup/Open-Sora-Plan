...
# --------------------------------------------------------
# References:
# NaViT implemention from: https://github.com/kyegomez/NaViT/tree/main
# --------------------------------------------------------
...
class NaViT(nn.Module):
    def __init__(
        ...
        *, 
        ...
        patch_size, 
        # num_classes, 
        dim, # transformer hidden dim and output dim size
        depth, # depth or transformer layer
        heads, # number of heads
        mlp_dim,# FFN hidden_layer_size 
