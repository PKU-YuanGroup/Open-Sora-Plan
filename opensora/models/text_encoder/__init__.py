...
class T5Wrapper(nn.Module):
    def __init__(self, args, **kwargs):
        ...
        self.text_enc = T5EncoderModel.from_pretrained(r'/storage/ongoing/new/Open-Sora-Plan/cache_dir/models--DeepFloyd--t5-v1_1-xxl/snapshots/c9c625d2ec93667ec579ede125fd3811d1f81d37', cache_dir=args.cache_dir, **kwargs).eval()
