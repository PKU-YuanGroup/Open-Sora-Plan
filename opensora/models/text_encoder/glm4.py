...
from opensora.models.text_encoder.glm4_utils import ChatGLMModel
...
if __name__ == '__main__':
    from opensora.models.text_encoder.glm4_utils import ChatGLMForConditionalGeneration, ChatGLM4Tokenizer
    device = "cuda:0" # the device to load the model onto
    model_path = "/storage/ongoing/12.13/t2i/Open-Sora-Plan/cache_dir/glm-4-9b-chat"
    ...
    text_enc = GLM4Wrapper(model_path).to(device)
    print(text_enc)
